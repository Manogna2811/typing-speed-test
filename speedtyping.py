...
title = Label(root, text="TYPING SPEED TEST", anchor=CENTER, font="Arial 50 bold", bg="Hotpink4", fg='black', relief="solid")
title.place(x=115, y=10)

# // INPUT BOX FROM THE USER    //##
large_font = ('Verdana',20)
e = Entry(root, width='50',bg="#F2BC94", fg="black",font=large_font)
e.place(x=100, y=300)
e.focus()
...
reset = Button(root, text="RESET", bg="HotPink4", fg="black", font="helvetica 20", padx=20, pady=10, relief=RAISED,
               command=clearfunc)
...
switch = Button(root, text="SWITCH-UP", bg='HotPink4', fg='black', font="helvetica 20", padx=10, pady=10, relief=RAISED, command=randomTXT)
...
result = Button(root, text="RESULT", bg="HotPink4", fg="black", font="helvetica 20", padx=10, pady=10, relief=RAISED,
               command=calculate).place(x=550,y=380)
root.mainloop()